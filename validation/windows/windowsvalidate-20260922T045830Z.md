...
?? validation/windows/windowsvalidate-20260922T045830Z.log.Length -gt 0)

## Steps

| Step | Status | Exit | Seconds |
|---|---|---:|---:|
| python-version | PASS | 0 | 0.064 |
| windows-focused-corpus | PASS | 0 | 26.3 |
| windows-regression-suite | FAIL | 1 | 861.862 |

Failed: windows-regression-suite

Raw output: [$ArchiveStem.log](./windowsvalidate-20260922T045830Z.log)
Machine-readable receipt: [$ArchiveStem.json](./windowsvalidate-20260922T045830Z.json)
